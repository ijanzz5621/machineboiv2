<%@ Page Title="Invoice Info Listing" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="InvoiceInfoList.aspx.vb" Inherits="MDS.App.InvoiceInfoList" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <h3> Invoice Info Listing</h3>
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <asp:Label ID="lblPONo" runat="server" Text="PO No#" CssClass=""></asp:Label>
        </div>
        <div class="col-md-4">
        ...
        <hr></hr>
        <div class="col-md-2">
            <asp:Label ID="lblCarNo" runat="server" Text="CAR No#" CssClass=""></asp:Label>
        </div>
        <div class="col-md-4">
            <asp:TextBox ID="TxtCarNo" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
    </div>
