...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-md-2 col-sm-4" style="margin-top:10px;">
            Reamining Day From <br />
            <asp:TextBox ID="txtRemainDayFrom" runat="server" CssClass="form-control" ReadOnly="false" TextMode="Number"></asp:TextBox>
        </div> 
        
        <div class="col-md-2 col-sm-4" style="margin-top:10px;">
            Remaining Day To <br />
            <asp:TextBox ID="txtRemainDayTo" runat="server" CssClass="form-control" ReadOnly="false" TextMode="Number"></asp:TextBox>
        </div> 
